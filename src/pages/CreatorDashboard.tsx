      ...
      <main className="ml-64 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Track your tiered creator economy performance</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <Card className="bg-gradient-card border-border shadow-card">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-foreground">{(stats.totalWatchTime / 60).toFixed(0)}h</div>
                <p className="text-xs text-muted-foreground">
                  <TrendingUp className="inline h-3 w-3 mr-1" />
            ...
            <Card className="bg-gradient-card border-border shadow-card">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-foreground">{stats.engagementRate}%</div>
                <p className="text-xs text-muted-foreground">
                  <TrendingUp className="inline h-3 w-3 mr-1" />
                  +2.1% from last month
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-gradient-card border-border shadow-card">
              <CardHeader>
                <CardTitle className="text-foreground">Tier Performance</CardTitle>
              ...
              <CardContent className="space-y-4">
                {mockTiers.map((tier, index) => (
                  <div key={tier.id} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                    <div className="flex items-center gap-3">
                      <div className={`p-2 rounded-full ${
                        ...
                        {index === 2 ? <Crown className="h-4 w-4 text-white" /> : <Users className="h-4 w-4" />}
                      </div>
                      <div>
                  ...
                  <div key={video.id} className="flex items-center justify-between p-4 bg-muted rounded-lg">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Tier: {video.tier}</p>
                      </div>
                    </div>
