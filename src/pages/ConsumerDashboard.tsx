      ...
      <main className="ml-64 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Manage your creator subscriptions and exclusive content</p>
          </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-secondary font-medium">{creator.username}</p>
                    <p className="text-muted-foreground">{creator.subscribers} followers</p>
                  </div>
                </div>
                <Button asChild>
            ...
            <CardContent>
              ...
              <div className="bg-muted rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="font-semibold text-foreground">Current Plan: Super Fan</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <Card className="bg-gradient-card border-border shadow-card">
                <CardHeader>
                  <CardTitle className="text-foreground">Exclusive Content</CardTitle>
                      ...
                      <div key={index} className="flex items-center gap-4 p-4 bg-muted rounded-lg hover:bg-muted/80 transition-colors cursor-pointer">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                            <Badge variant="outline" className="text-xs">{video.tier}</Badge>
            ...
            <Card className="bg-gradient-card border-border shadow-card">
              ...
              <CardContent>
                ...
                <div className="mt-6 pt-6 border-t border-border">
                  ...
                  <Button variant="ghost" className="w-full mt-2 text-destructive">
                    Cancel Subscription
                  </Button>
                </div>
              </CardContent>
